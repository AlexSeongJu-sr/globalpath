...
def get_parameters():
    ...
    parser.add_argument('--origin', default = (-4.2, -3.64), help = 'origin coordinates in map.yaml')
    parser.add_argument('--slam_map', default = './slam_map/map_0726.pgm', help = 'map directory')
    parser.add_argument('--object_category', default = ['teddy bear', 'bottle', 'backpack', 'chair', 'cup', 'couch'], help = 'object category to look for')

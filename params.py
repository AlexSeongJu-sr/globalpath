...
def get_parameters():
    ...
    parser.add_argument('--origin', default = (-4.63, -3.68), help = 'origin coordinates in map.yaml')
    parser.add_argument('--slam_map', default = './slam_map/map_0709.pgm', help = 'map directory')
